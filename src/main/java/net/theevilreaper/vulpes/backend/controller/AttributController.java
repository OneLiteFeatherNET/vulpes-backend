...
public class AttributController {
    ...
    @Inject
    public AttributController(AttributeRepository attributeRepository) {
        this.attributeRepository = attributeRepository;
    }

    @Post
    public HttpResponse<AttributeModel> add(AttributeModel attributModel) {
        return HttpResponse.ok(attributeRepository.save(attributModel));
    }
